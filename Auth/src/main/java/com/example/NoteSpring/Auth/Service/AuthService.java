...
import com.example.NoteSpring.Auth.ApiResponseBody.ApiFailResponse;
import com.example.NoteSpring.Auth.ApiResponseBody.ApiSuccessResponse;
import com.example.NoteSpring.Auth.ApiResponseBody.ResponseBody;
import com.example.NoteSpring.Auth.DTO.RequestSchema.LoginUser;
import com.example.NoteSpring.Auth.DTO.RequestSchema.SignupUser;
import com.example.NoteSpring.Auth.DTO.ResponseSchema.TokenSchema;
import com.example.NoteSpring.Auth.DTO.ResponseSchema.UserResponseSchema;
import com.example.NoteSpring.Auth.Model.ResetPassword;
import com.example.NoteSpring.Auth.Model.User;
import com.example.NoteSpring.Auth.Model.VerifyAuth;
import com.example.NoteSpring.Auth.Repository.AuthRepository;
import com.example.NoteSpring.Auth.Repository.ResetPasswordRepository;
import com.example.NoteSpring.Auth.Repository.VerifyAuthRepository;
import com.example.NoteSpring.Auth.Service.Mails.MailBodyBuilder;
import com.example.NoteSpring.Auth.Utils.BcryptUtils;
import com.example.NoteSpring.Auth.Utils.JwtUtils;
import com.example.NoteSpring.Auth.Utils.TokenUtils;
...
public class AuthService {
    ...
    public ResponseBody login(LoginUser body){
        ...
        return new ApiSuccessResponse<TokenSchema>(true, HttpStatus.OK, "User created successfully, Verify to continue",new TokenSchema(token));

    }
    public ResponseBody register(SignupUser body){
        ...
        return new ApiSuccessResponse<TokenSchema>(true, HttpStatus.CREATED, "User created successfully, Verify to continue",new TokenSchema(token));
//        return null;
    }
    public ResponseBody verifyUser(String token, String OTP, HttpServletResponse response){
        ...
        String t = JwtUtils.generateToken(user.getId());
...
//        cookie.setSecure(true);
    ...
    public ResponseBody getMe(String token){
    ...
    public ResponseBody forgotPasswordOrChangePassword(String email){
        ...
        return new ApiSuccessResponse<Object>(HttpStatus.ACCEPTED,"Reset password link has been sent your email", null);
    }
    public ResponseBody resetPassword(String token, String password){
        ...
        return new ApiSuccessResponse<Object>(HttpStatus.ACCEPTED,"Password has been modified successfully", null);
    }
    public ResponseBody resendOTP(String token){
        if(!verifyAuthRepository.existsByToken(token)){
            return new ApiFailResponse(HttpStatus.NOT_FOUND, "Invalid Token");
        }
        ...
        return new ApiSuccessResponse<Object>(HttpStatus.OK, "Otp has been sent to email", null);
    }
}
