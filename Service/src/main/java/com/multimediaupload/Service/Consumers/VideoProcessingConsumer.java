package com.multimediaupload.Service.Consumers;
...
@Service
public final class VideoProcessingConsumer {

    private final FFmpeg ffmpeg;
    private final FFprobe ffprobe;

    public VideoProcessingConsumer() throws IOException {
    ...
    public void transcodeVideo(String inputPath) {
        try {
